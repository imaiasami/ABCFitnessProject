...
public class ProfileController {
	...
	public String goProfile(HttpServletRequest request) {
		...
		if (memberLogin == null)
			return "redirect:/login?redirectURL=profile";
		else
			return "redirect:/profile/" + memberLogin.getMem_id();
	}
	...
	public String profileHome(@PathVariable("mem_id") String mem_id, Model model) {
		...
		List<Routine> routineBookmarked = memberMapper.getRoutineBookmarkList(memberProfile.getMem_no());
